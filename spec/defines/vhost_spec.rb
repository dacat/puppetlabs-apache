      ...
      let :params do
        {
          ...
          'directories'                 => [
              ...
              },
              {
                  'path'     => '/var/www/files',
                  'provider' => 'files',
                  'require'  => { 'enforce'  => 'all', 'requires' => ['all-valid1', 'all-valid2'], },
              },
              {
                  'path'     => '/var/www/files',
                  'provider' => 'files',
                  'require'  => { 'enforce'  => 'none', 'requires' => ['none-valid1', 'none-valid2'], },
              },
              {
                  'path'     => '/var/www/files',
                  'provider' => 'files',
                  'require'  => { 'enforce'  => 'any', 'requires' => ['any-valid1', 'any-valid2'], },
              },
              {
                  'path'     => '*',
                  'provider' => 'proxy',
              ...
              },
              {
                  'path'     => '/var/www/files',
                  'provider' => 'location',
                  'limit'    => [ { 'methods' => 'GET HEAD', 'require' => ['valid-user'] }, ],
              },
              {
                  'path'         => '/var/www/files',
                  'provider'     => 'location',
                  'limit_except' => [ { 'methods' => 'GET HEAD', 'require' => ['valid-user'] }, ],
              },
              {
                  'path'               => '/var/www/dav',
                  'dav'                => 'filesystem',
          ...
          'filters'                     => [
              ...
              'FilterChain COMPRESS', 'FilterProtocol COMPRESS  DEFLATE change=yes;byteranges=no',
          ],
          ...
          'passenger_app_group_name'                            => 'group',
          ...
          'passenger_sticky_sessions_cookie_name'               => 'my_passenger_cookie',
          ...
          'suphp_engine'                => 'on',
          'union_station_filter'          => 'filter this thing',
          'union_station_gateway_address' => 'http://gateway.union.station.com',
          'union_station_gateway_cert'    => '/var/my/certs',
          'union_station_gateway_port'    => '8989',
          'union_station_key'             => 'ABCDE-1234-3333',
          'union_station_proxy_address'   => 'https://user:password@proxy.station.com',
          ...
          'wsgi_script_aliases_match'   => { '^/test/(^[/*)' => '/var/www/demo.wsgi' },
        }
      end
      let :facts do
        {
